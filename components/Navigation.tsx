    ...
    <>
      {open && (
        <div
          ...
          className="lg:hidden fixed inset-0 z-30 animate-[fadeIn_0.3s_ease] cursor-pointer"
          style={{
            backdropFilter: "blur(20px) saturate(150%)",
            WebkitBackdropFilter: "blur(20px) saturate(150%)",
            background:
              "linear-gradient(180deg, rgba(15, 7, 41, 0.55) 0%, rgba(15, 7, 41, 0.4) 100%)",
          }}
        />
      )}
      ...
      >
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <nav
            className={`relative flex items-center justify-between rounded-full px-4 sm:px-6 py-2.5 transition-all duration-500 ${
              scrolled
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                aria-expanded={open}
                className="lg:hidden w-10 h-10 inline-flex items-center justify-center rounded-full glass relative z-10"
              >
          ...
          {open && (
            <div
              className="lg:hidden mt-3 rounded-2xl p-4 animate-[fadeIn_0.3s_ease] ring-1 ring-gold/20 shadow-2xl shadow-purple-900/40 relative z-10"
              style={{
                background: "rgba(15, 7, 41, 0.85)",
